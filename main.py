...
MAX_VIDEO_DURATION = _get_env("MAX_VIDEO_DURATION", 2400, cast=int)
...
Feel free to send me the video link you want to download.

At the moment, our resources are limited, so the bot can only handle videos up to:

📌 YouTube: Maximum 10 minutes
📌 Other platforms (TikTok, Instagram, Facebook, etc.): Maximum 40 minutes

This limit helps ensure the bot stays fast, stable, and available for everyone — especially when handling large or high-quality videos.

🚀 Good news: As the bot grows and more resources become available, we will increase these limits. In the near future, you’ll be able to download videos up to 2 hours long.
...
Thanks for your understanding and support!
"""
    telebot_bot.send_message(message.chat.id, text)
